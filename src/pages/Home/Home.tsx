...
export default function Home() {
	...
	return (
		...
		>
			<section className="pt-[7.5rem] mx-auto lg:max-w-[1250px] tracking-wide">
				<h1 className="font-bold text-[44px] leading-[3.5rem] text-white">
				...
				<div className="flex gap-x-7 mt-6">
					<div className="bg-white opacity-90 py-6 px-5 w-[230px] rounded-[20px] custom-shadow cursor-pointer hover:scale-105 transition-all">
				...
				<div className="flex gap-x-7 mt-8">
					<button className="py-4 px-9 bg-green-400 font-semibold text-white tracking-wide text-[18px] rounded-[12px] hover:scale-105 active:scale-95 transition-all custom-shadow">
						Bepul konsultatsiya
					</button>
					<button className="py-4 px-9 bg-sky-400 font-semibold text-white tracking-wide text-[18px] rounded-[12px] hover:scale-105 active:scale-95 transition-all custom-shadow">
						Tayyor tur paketlar
					</button>
				</div>
			</section>
